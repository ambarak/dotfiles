...
Plugin 'milkypostman/vim-togglelist' " Functions to toggle the [Location List] and the [Quickfix List] windows. vim-devicons must be 

"loaded after all other plugins needs a good font with icons, like patched fonts you can find at https://github.com/: ryanoasis/"nerd-fonts
